...
int CRecvJobState::HandleEncode(CAsyncFrame *pFrame,
        ...
        CMsgBase *pMsg) 
{
	...
	#endif
	cout << "now in state recv job, do nothing" << endl;
	pFrame->FRAME_LOG( LOG_DEBUG, "now in state recv job, do nothing");
        ...
        CMsgBase *pMsg)
{
    ...
    */
    pFrame->FRAME_LOG( LOG_DEBUG, "debug: state job_publish process, return finished");
