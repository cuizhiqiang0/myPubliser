...
int CWaitingState::HandleEncode(CAsyncFrame *pFrame,
        ...
        CMsgBase *pMsg) 
{
    ...
    pAction1->SetID(1);
    pAction1->SetDestIp(SERVER_IP);
    pAction1->SetDestPort(SERVER_PORT);
    ...
    pAction2->SetID(2);
    pAction2->SetDestIp(SERVER_IP);
    pAction2->SetDestPort(SERVER_PORT);
...
int CGetState::HandleProcess(CAsyncFrame *pFrame,
        ...
        CMsgBase *pMsg)
{
    int nNextStateID = STATE_RECV_JOB;
